...
public class BuildVars {
    ...
    public static int APP_ID = 2088932;
    public static String APP_HASH = "3e4e1249505315e82f3490e3a220d9ad";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "network.zov.messenger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
